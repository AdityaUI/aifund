                          ...
                          if (_registerFormKey.currentState.validate()) {
                            print("SET0");
                              FirebaseAuth.instance.createUserWithEmailAndPassword(
                                ...
                                print("SET1");
                                var database = Firestore.instance.document("users/"+currentUser.user.uid);
                                KeyPair kp = KeyPair.random();
                                database.setData({"Public Key": kp.accountId.toString(), "Secret Seed": kp.secretSeed.toString()});
                                print("SET2");
